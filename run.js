...
console.log(Pi);
mh.adding(10).substract(5).result(); // 1 + 10 - 5 = 6
mh.initialNum(6).adding(3).multiply(4).divide(6).result(); // current result is 6 then the result is: 6 + 3 * 4 / 6 = 6
mh.initialNum(7); // set jari-jari 7
console.log(`nilai sekarang : ${mh.number}`);
